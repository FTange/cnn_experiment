...
if __name__ == "__main__":
    ...
    alex.compile(optimizer=tf.train.RMSPropOptimizer(0.001),
                 loss='categorical_crossentropy',
                 metrics=['accuracy'])


    alex.fit(data, labels_matrix, batch_size=32, epochs=10)
    y_pred = alex.predict(x_test)

    print(accuracy_score(np.apply_along_axis(np.argmax, 1, y_test),
